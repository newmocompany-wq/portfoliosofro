...
export function CoverCard({
  ...
  const content = <Card className="h-full flex flex-col">
      <div className="relative aspect-[16/10] overflow-hidden">
        ...
        {eyebrow && <span className="absolute top-3 left-3 rounded-full bg-electric/90 px-2.5 py-0.5 text-[10px] font-mono uppercase tracking-widest text-electric-foreground">
            {eyebrow}
          </span>}
      </div>
