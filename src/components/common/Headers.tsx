...
export function SectionHeader({
  ...
  return (
    <div className={`flex flex-col gap-3 ${align === "center" ? "items-center text-center" : ""} mb-10`}>
      {eyebrow && (
...
export function PageHeader({
  ...
  return (
    <section className="relative border-b border-border/60 bg-card/30">
      <div className="container-academic py-14 md:py-20">
        {eyebrow && (
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-electric mb-3">{eyebrow}</p>
        )}
